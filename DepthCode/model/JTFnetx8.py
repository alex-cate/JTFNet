...
class CALayer(nn.Module):
    def __init__(self, n_feats, bias=True):
        ...
        self.conv_du = nn.Sequential(common.ConvBlock(n_feats, n_feats, kernel_size=1, stride=1, padding=0, bias=bias))
...
class DepthNetX8(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        for i in range(3):
            ...
            # self.sr_stage.append(SR_Stage(n_feats, kernel_size, padding, filter_size, bias=True, act=act))
