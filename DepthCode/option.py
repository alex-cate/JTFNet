...
parser.add_argument('--n_GPUs', type=int, default=1,
                    help='number of GPUs')
parser.add_argument('--GPU_id', type=str, default="0", choices=['0','1'],
                    help='if n_GPUs==1, specify GPU index')
parser.add_argument('--seed', type=int, default=1,
                    help='random seed')

# Data specifications
parser.add_argument('--dir_data', type=str, default='/DISK/wh/Data/DEPTH',
                    help='dataset directory')
parser.add_argument('--dir_demo', type=str, default='./test',
                    help='demo image directory')
parser.add_argument('--data_train', type=str, default='MM',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='tsukuba',
                                        help='test dataset name')
parser.add_argument('--benchmark_noise', action='store_true',
                    help='use noisy benchmark sets')
parser.add_argument('--n_train', type=int, default=52298, # 52298 11444
...
# art + books + moebius + dolls + laundry + reindeer + tsukuba + venus + teddy + cones