...
parser.add_argument('--data_train', type=str, default='NYU',
                    help='train dataset name')
parser.add_argument('--data_test', type=str, default='nyu',
                                        help='test dataset name')
parser.add_argument('--benchmark_noise', action='store_true',
                    help='use noisy benchmark sets')
parser.add_argument('--n_train', type=int, default=1000, # 52298
