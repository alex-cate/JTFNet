...
class JBF(nn.Module):
    def __init__(self, type, n_feats, kernel_size, padding, filter_size, group_num, bias=True, act=nn.PReLU()):
        ...
        self.jbf_conv = nn.Sequential(
            common.ConvBlock(32, n_feats, kernel_size=kernel_size, stride=1, padding=padding, bias=bias,
                             act=act),
...
class DepthNetX4(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        self.multiscale_fusion=Multi_Scale_Fusion(n_feats, kernel_size, padding, filter_size, group_num, bias=True, act=act)
    ...
    def forward(self, depth, color):
        ...
        depth_ten_x8 = self.sr_stage[2](update_x4, color)
        update_x4 = self.invertion_fusion(update_x4, depth_ten_x8)
