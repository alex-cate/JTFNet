...
## CrossEdge_Net (CEN)
class DepthNetX16(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(DepthNetX16, self).__init__()
    ...
    def forward(self, depth, color):
        ...
        depth_ten_x16 = self.sr_stage[3](update_x8, color_ten_x16)
        update_x16 = self.multiscale_fusion[2](update_x8, depth_ten_x16)

        depth_sr = self.depth_recon(update_x16)
