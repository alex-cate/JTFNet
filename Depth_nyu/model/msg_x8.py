...
class MSG(nn.Module):
    def __init__(self, args):
        ...
        #     common.ConvBlock(1, n_feats, kernel_size=5, stride=1, padding=1, bias=True, act=act))
    ...
    def forward(self, depth, color):
        ...
        color_ten_x4 = self.color_fun_x4(color)
        ...
        depth_ten_x8 = torch.cat([depth_ten_x8, color], dim=1)
        depth_ten_x8 = self.sr_stage_x8(depth_ten_x8)
        # print(depth_ten_x8.shape)

        depth_sr = self.depth_recon(depth_ten_x8)
